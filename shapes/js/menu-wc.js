...
customElements.define('compodoc-menu', class extends HTMLElement {
    ...
    render(isNormalMode) {
        ...
        <nav>
            <ul class="list">
                <li class="title">
                    <a href="index.html" data-type="index-link">@ng-maps/shapes</a>
                </li>
                ...
                <li class="chapter">
                    ...
                    <li class="chapter modules">
                        ...
                        <ul class="links collapse " ${ isNormalMode ? 'id="modules-links"' : 'id="xs-modules-links"' }>
                            <li class="link">
                                <a href="modules/NgMapsShapesModule.html" data-type="entity-link">NgMapsShapesModule</a>
                            </li>
                </ul>
                </li>
                    <li class="chapter">
                        ...
                        <li class="chapter">
                            ...
                            <ul class="links collapse " ${ isNormalMode ? 'id="directives-links"' : 'id="xs-directives-links"' }>
                                <li class="link">
                                    <a href="directives/NgMapsCircle.html" data-type="entity-link">NgMapsCircle</a>
                                </li>
                                <li class="link">
                                ...
                                <li class="link">
                                    <a href="directives/NgMapsRectangle.html" data-type="entity-link">NgMapsRectangle</a>
                                </li>
                            </ul>
                        </li>
                        <li class="chapter">
